...
const Header = () => {
  return (
    <header className="w-full px-4 sm:px-8 md:px-[12%] h-screen flex flex-col items-center justify-center gap-4 text-center">
      ...
      {/* Foto de perfil */}
      <div>
        <Image src={assets.perfil} alt="Lucas Filipe" className="rounded-full w-24 sm:w-28 md:w-32" />
      </div>

      {/* Saudação */}
      <h3 className="flex items-center sm:items-end gap-2 text-lg sm:text-xl md:text-2xl font-Ovo mb-2">
        Olá, Eu sou Lucas Filipe
        <Image src={assets.hand_icon} alt="Mão acenando" className="w-5 sm:w-6" />
      </h3>
      ...
      <p className="mt-4 text-sm sm:text-base md:text-lg max-w-2xl font-Ovo leading-relaxed">
        ...
        Transformo ideias em aplicações web performáticas e escaláveis. Histórico de desenvolvimento de aplicações web completas, com foco em performance, usabilidade e código limpo.
      </p>
